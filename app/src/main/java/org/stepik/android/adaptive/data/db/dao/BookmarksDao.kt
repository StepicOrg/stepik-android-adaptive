...
constructor(databaseOperations: DatabaseOperations) : DaoBase<Bookmark>(databaseOperations) {
    override fun getDbName(): String =
        BookmarksDbStructure.TABLE_NAME

    override fun getDefaultPrimaryColumn(): String =
        BookmarksDbStructure.Columns.STEP_ID

    override fun getDefaultPrimaryValue(persistentObject: Bookmark): String =
        persistentObject.stepId.toString()

    override fun getContentValues(persistentObject: Bookmark): ContentValues =
        ContentValues().apply {
